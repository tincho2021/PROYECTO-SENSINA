...
let clientDb = {
  ...
  dispensers: [...mockDispensers] as Dispenser[],
  drivers: [...mockDrivers],
  vehicles: [...mockVehicles],
  transactions: [...mockTransactions] as FuelTransaction[],
  deliveries: [...mockDeliveries] as Delivery[],
  reconciliations: [...mockReconciliations] as InventoryReconciliation[],
